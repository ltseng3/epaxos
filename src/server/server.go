...
var batchSize *int = flag.Int("bsize", 50000, "Batch Size. Defaults to 50000")
var batchClock *int = flag.Int("bclock", 5000, "Batch Clock. Defaults to 5000")
...
func main() {
	...
	if *doEpaxos {
		...
		rep := paxos.NewReplica(replicaId, nodeList, *thrifty, *exec, *dreply, *durable, *batchSize, *batchClock)
		rpc.Register(rep)
	}
